create view mamaison_annonce_searh as 
select 
    a.*,
    u.username as 'user_username',
    ta.valeur as 'type_annonce_type',
    cat.type as 'category_type',
    car.id as 'caracteristique_id',
    car.nom as 'caracteristique_nom',
...
create or replace view mamaison_annonce_searh as
select     
    a.id,
    a.titre,
    a.description,
